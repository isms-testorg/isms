...
controls: [A.5.10, A.5.11, A.6.7, A.7.7, A.8.1]
---
...
Informationen und zugehörige Werte werden nur für autorisierte Geschäftszwecke genutzt. Nutzer schützen Zugangsdaten, halten Bildschirme und Ausdrucke vor unbefugter Einsicht geschützt, verwenden verwaltete Endgeräte, melden Verlust oder Missbrauch sofort und installieren keine nicht genehmigte Software, umgehen keine Schutzmaßnahmen und nutzen Unternehmensmittel nicht für rechtswidrige, diskriminierende oder schädliche Aktivitäten. Bei mobiler Arbeit sind private, ausreichend geschützte Arbeitsbereiche und genehmigte Verbindungen zu verwenden.
...
- **A.6.7** Arbeiten aus der Ferne
- **A.7.7** Aufgeräumte Arbeitsumgebung und Bildschirmsperren
- **A.8.1** Endpunktgeräte von Benutzern
