...
title: Richtlinie für Netzwerk- und Übertragungssicherheit
lang: de
version: 0.1.0
...
Informationsübertragungen verwenden genehmigte Kanäle, Empfängerprüfung und klassifizierungsabhängige Schutzmaßnahmen. Öffentliche Schnittstellen werden minimiert; Cloud-Netze, Repositorys, CI/CD-Runner und administrative Wege werden soweit praktikabel getrennt. Netzwerkdienste nutzen sichere Konfigurationen und Verschlüsselung. Streng vertrauliche oder personenbezogene Daten werden in Nichtproduktionsumgebungen maskiert und auf unzulässige Offenlegung überwacht. Webfilter und Endgeräteschutz reduzieren schädliche oder unbefugte Zugriffe; Ausnahmen werden dokumentiert.
