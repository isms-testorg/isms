...
Security responsibilities are defined before access is granted to employees and contractors. Screening is proportionate to role and law; contracts include confidentiality, acceptable use, privacy, and security duties. Personnel complete induction and annual awareness training, with role-specific training for privileged or sensitive work. Breaches may trigger the documented disciplinary process. Access and information are returned or revoked at role change and termination.
