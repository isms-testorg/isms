...
Because staff work remotely, physical protection is applied to home offices, coworking spaces, equipment storage, and any supplier-hosted facilities. Workers prevent unauthorised entry and viewing, secure devices when unattended, and report theft, damage, environmental threats, utility failure, or maintenance concerns. Equipment is positioned and maintained to reduce damage and disclosure; cables, media, and off-premises assets are protected. Critical facility controls are assessed through supplier assurance.
