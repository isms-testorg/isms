...
Information and associated assets are used only for authorised business purposes. Users protect credentials, keep screens and printed material clear of unauthorised viewing, use managed endpoints, report loss or misuse immediately, and do not install unapproved software, bypass safeguards, or use company resources for unlawful, discriminatory, or harmful activity. Remote work uses private, adequately protected workspaces and approved connections.
